...
<form class="form container <? if (!empty($errors)) : ?>form--invalid<? endif; ?>" action="registration.php"
    ...
    <div class="form__item <? if (!empty($errors["email"])) : ?> form__item--invalid <? endif; ?>">
        ...
        <input id="email" type="email" name="email" placeholder="Введите e-mail"
               value="<?= htmlspecialchars(post_value("email")) ?>">
    ...
    <input id="password" type="password" name="password" placeholder="Введите пароль"
           value="<?= htmlspecialchars(post_value("password")) ?>">
    ...
    <input id="name" type="text" name="name" placeholder="Введите имя"
           value="<?= htmlspecialchars(post_value("name")) ?>">
    ...
    <textarea id="message" name="message"
              placeholder="Напишите как с вами связаться"><?= htmlspecialchars(post_value("message")) ?></textarea>
